...
{/*Categoris*/}
    ...
    <div className="flex justify-center items-center space-x-2 mr-4 bg-gray-200 px-2 py-1 rounded-md ">
      <p>tech</p>
    <p className="text-white bg-black rounded-full curser-pointer p-1 text-sm">  <ImCross/></p>
    <div className="flex justify-center items-center space-x-2 mr-4 bg-gray-200 px-2 py-1 rounded-md ">
      <p>tech</p>
    <p className="text-white bg-black rounded-full curser-pointer p-1 text-sm">  <ImCross/></p>
    </div>
  ...
  < textarea row={15} cols={30} className="px-4 py-2 outline-none " placeholder="Enter Post Discription"/>
    
    <button className="bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 pt-2 md:text-xl text-lg"> Create </button>
</form>
        </div>
        <Footer/>
    </div>
