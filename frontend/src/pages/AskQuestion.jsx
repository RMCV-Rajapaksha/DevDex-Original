...
import { FaTimes, FaPlus, FaImage, FaTags, FaPaperPlane, FaLightbulb } from "react-icons/fa";
                    ...
                    >
                        ...
                        <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-5 mb-6">
                            <h3 className="font-semibold text-blue-400 mb-3 flex items-center gap-2">
                                <FaLightbulb /> Writing a good question
                            </h3>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="bg-slate-800/50 backdrop-blur rounded-xl border border-slate-700 p-6">
                                ...
                                <p className="text-slate-400 text-sm mb-3">
                                    Add a screenshot or diagram if it helps explain your question.
                                </p>
                                <input
                                    type="file"
                                    accept="image/*"
                            ...
                            <div className="flex gap-4">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="flex-1 py-3 bg-gradient-to-r from-orange-500 to-pink-500 text-white font-semibold rounded-xl hover:from-orange-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-orange-500/25 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {loading ? (
                                        <div className="w-5 h-5 border-2 border-white/20 border-t-white rounded-full animate-spin" />
                                    ) : (
                                        <>
                                            <FaPaperPlane /> Post Your Question
                                        </>
                                    )}
                                </button>
                                <button
