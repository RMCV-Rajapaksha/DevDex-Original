 ...
 return (
    <div>
        ...
        <div className="px-6 md:px-[200px] mt-8">
          <h1 className="font-bold md:text-2xl text-xl mt-8">Update solution</h1>
...
<p onClick={deleteCategory} className="text-white bg-black rounded-full curser-pointer p-1 text-sm">  <ImCross/></p>
  ...
  < textarea row={15} cols={30} className="px-4 py-2 outline-none " placeholder="Enter Post Discription"/>
    ...
    <button className="bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 pt-2 md:text-xl text-lg"> Update </button>
</form>
        </div>
        <Footer/>
    </div>
